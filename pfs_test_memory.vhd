...
ARCHITECTURE circ1 OF pfs_test_memory IS
BEGIN
	WITH entrada SELECT
				   --	saida			 entrada
		saida <=	"00100000" WHEN "00000000", -- mem0  LDA
					"10000000" WHEN "00000001", -- mem1  128
					"01010000" WHEN "00000010", -- mem2  AND
					"10000001" WHEN "00000011", -- mem3  129
					"00110000" WHEN "00000100", -- mem4  ADD
					"10000010" WHEN "00000101", -- mem5  130
					"00110000" WHEN "00000110", -- mem6  ADD
					"10000011" WHEN "00000111", -- mem7  131
