...
ARCHITECTURE structure OF pfs_uc4 IS
...
-- Equation(s):
-- \inst1|inst~0_combout\ = \inst1|inst~q\ $ (\inst|inst~q\)
...
-- Equation(s):
-- \inst2|inst~0_combout\ = \inst2|inst~q\ $ (((\inst|inst~q\ & \inst1|inst~q\)))
...
-- Equation(s):
-- \inst3|inst~0_combout\ = \inst3|inst~q\ $ (((\inst|inst~q\ & (\inst2|inst~q\ & \inst1|inst~q\))))
