...
-- z	=>  Location: PIN_N10,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF pfs_full_adder IS
...
-- Equation(s):
-- \inst1|inst~0_combout\ = \x~input_o\ $ (\z~input_o\ $ (\y~input_o\))
...
-- Equation(s):
-- \inst2~0_combout\ = (\x~input_o\ & ((\z~input_o\) # (\y~input_o\))) # (!\x~input_o\ & (\z~input_o\ & \y~input_o\))
