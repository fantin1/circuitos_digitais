...
-- sq	=>  Location: PIN_A8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF pfs_accumulator IS
...
-- Equation(s):
-- \inst~0_combout\ = \inst~q\ $ (\d~input_o\)
