...
-- out[7]	=>  Location: PIN_L7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- out[6]	=>  Location: PIN_M6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- out[5]	=>  Location: PIN_N8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- out[0]	=>  Location: PIN_L9,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF pfs_decod_3x8 IS
...
-- Equation(s):
-- \inst~0_combout\ = (\a[0]~input_o\ & (\a[1]~input_o\ & \a[2]~input_o\))
...
-- Equation(s):
-- \inst~1_combout\ = (!\a[0]~input_o\ & (\a[1]~input_o\ & \a[2]~input_o\))
...
-- Equation(s):
-- \inst~2_combout\ = (\a[0]~input_o\ & (!\a[1]~input_o\ & \a[2]~input_o\))
...
-- Equation(s):
-- \inst~3_combout\ = (!\a[0]~input_o\ & (!\a[1]~input_o\ & \a[2]~input_o\))
...
-- Equation(s):
-- \inst~4_combout\ = (\a[0]~input_o\ & (\a[1]~input_o\ & !\a[2]~input_o\))
...
-- Equation(s):
-- \inst~5_combout\ = (!\a[0]~input_o\ & (\a[1]~input_o\ & !\a[2]~input_o\))
...
-- Equation(s):
-- \inst~6_combout\ = (\a[0]~input_o\ & (!\a[1]~input_o\ & !\a[2]~input_o\))
...
-- Equation(s):
-- \inst~7_combout\ = (!\a[0]~input_o\ & (!\a[1]~input_o\ & !\a[2]~input_o\))
